                ...
                <div className="row">
                    ...
                    <div className="container py-5">
                        <div className="row pb-5">
                            <div className="col-md-3 p-2" data-aos="flip-left" data-aos-duration="1000">
                            ...
                            <div className="col-md-3 p-2" data-aos="flip-left" data-aos-duration="1500">
                                <Card style={{ width: '18rem' }} className="bg-warning">
                            ...
                            <div className="col-md-3 p-2" data-aos="flip-left" data-aos-duration="2000">
                                <Card style={{ width: '18rem' }} className="bg-warning">
                            ...
                            <div className="col-md-3 p-2" data-aos="flip-left" data-aos-duration="2500">
                                <Card style={{ width: '18rem' }} className="bg-warning">
