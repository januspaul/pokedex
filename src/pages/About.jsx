        ...
        <div className="BG">
            <div className="container">
                <div className="row aboutCol d-flex align-items-center justify-content-center">
                    <div className="col-6 text-white " data-aos="fade-up" data-aos-duration="2000">
                    ...
                    <div className="col-6 text-center" data-aos="fade-down" data-aos-easing="linear" data-aos-duration="1500">
            ...
            <div className="container d-flex align-items-center justify-content-center pb-4">
                <div className="row">
                    ...
                    <div className="col-4" data-aos="flip-left" data-aos-duration="2000">
                    ...
                    <div className="col-4" data-aos="flip-left" data-aos-duration="3000">
            ...
            <div className="container d-flex align-items-center justify-content-center pb-5">
                <div className="row">
                    <div className="col-3" data-aos="fade-up" data-aos-duration="1000">
                    ...
                    <div className="col-3" data-aos="fade-up" data-aos-duration="1250">
                    ...
                    <div className="col-3" data-aos="fade-up" data-aos-duration="1750">
