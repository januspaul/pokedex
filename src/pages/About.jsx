        ...
        <div className="BG">
            <div className="container">
                <div className="row aboutCol d-flex align-items-center justify-content-center">
                    <div className="col-md-6 text-white " data-aos="fade-up" data-aos-duration="2000">
                    ...
                    <div className="col-md-6 text-center" data-aos="fade-down" data-aos-easing="linear" data-aos-duration="1500">
                        <img src="abouthero1.png" alt="" className="img-fluid" />
                    </div>
                </div>
            </div>
            ...
            <div className="container d-flex align-items-center justify-content-center pb-4">
                <div className="row">
                    <div className="col-md-6 col-lg-6 col-xl-4 pb-3" data-aos="flip-left" data-aos-duration="1000">
                    ...
                    <div className="col-md-6 col-lg-6 col-xl-4 pb-3" data-aos="flip-left" data-aos-duration="2000">
                    ...
                    <div className="col-md-6 col-lg-6 col-xl-4 pb-3" data-aos="flip-left" data-aos-duration="3000">
                    ...
                    <div className="col-md-6 col-lg-6 col-xl-4 pb-3" data-aos="flip-left" data-aos-duration="1000">
                        <div className="aboutCard4">
                            <div>
                                ...
                                <p className="aboutCardText fs-5 px-3 py-2">We think “team first,” developing and strengthening col-mdlaborative partnerships with all teammates—internal and external—to get things done quicker, smarter, and better.</p>
                            </div>
                        </div>
                    </div>
                    <div className="col-md-6 col-lg-6 col-xl-4 pb-3" data-aos="flip-left" data-aos-duration="2000">
            ...
            <div className="container d-flex align-items-center justify-content-center pb-5">
                <div className="row">
                    <div className="col-lg-6 col-sm-3 col-md-6 col-xl-3 pt-5" data-aos="fade-up" data-aos-duration="1000">
                    ...
                    <div className="col-lg-6 col-sm-3 col-md-6 col-xl-3 pt-5" data-aos="fade-up" data-aos-duration="1250">
                    ...
                    <div className="col-lg-6 col-sm-3 col-md-6 col-xl-3 pt-5" data-aos="fade-up" data-aos-duration="1500">
                    ...
                    <div className="col-lg-6 col-sm-3 col-md-6 col-xl-3 pt-5" data-aos="fade-up" data-aos-duration="1750">
