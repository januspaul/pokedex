                        ...
                        {pokemons.length > 0 && (
                            <div className="row text-white d-flex align-items-center justify-content-center p-2">
                                ...
                                <div className="col-md-6 align-middle">
                                    <h1 className='text-center text-warning fst-italic text-uppercase fw-bolder mt-5' data-aos="fade-up" data-aos-anchor-placement="top-bottom" data-aos-duration="2100">{pokemons[0].name}</h1>
                                    <div className='display-6'>
                                        <table className='table table-borderless text-white'>
                                            <tbody>
                                                <tr data-aos="fade-up" data-aos-anchor-placement="top-bottom" data-aos-duration="2200">
                                                    <th scope="row"></th>
                                                    <td className='text-warning fs-2' >Height: </td>
                                                    <td className='fs-2'>{pokemons[0].height} m</td>
                                                </tr>
                                                <tr data-aos="fade-up" data-aos-anchor-placement="top-bottom" data-aos-duration="2300">
                                                    <th scope="row"></th>
                                                    <td className='text-warning fs-2'>Weight: </td>
                                                    <td className='fs-2'>{pokemons[0].weight} kg</td>
                                                </tr>
                                                <tr data-aos="fade-up" data-aos-anchor-placement="top-bottom" data-aos-duration="2400">
                                                    <th scope="row"></th>
                                                ...
                                                <tr data-aos="fade-up" data-aos-anchor-placement="top-bottom" data-aos-duration="2500">
                                                    <th scope="row"></th>
